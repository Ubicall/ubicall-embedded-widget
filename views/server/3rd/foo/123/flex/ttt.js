			...
			var flashvars = { 
				rtmp_url: 'rtmp://162.242.253.195/phone'
			};
		 ...
		 $(document).ready(function() {
			swfobject.embedSWF("http://10.0.0.161/ubicall/nodeifram/views/server/3rd/foo/plist/flex/freeswitch.swf", "flash", "250", "150", "9.0.0", "expressInstall.swf", flashvars, params, []);
		   ...
		   $("#callout").dialog({ 
			...
			$("a", "#guest_account").button();
                        //  login("8890000000000000025@162.242.253.195","I3Rw3nl0fpaVeocp");
		 });
